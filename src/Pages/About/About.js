    ...
    return (
        ...
        <div className="row">
            <div className="col-md-6">
                <img className="w-75" src="https://www.advancedeyecarefl.com/wp-content/uploads/group_-web.png" alt="" />
        
            </div>
            <div className="col-md-6 text-white">
                <p style={{margin:'50px'}}>Eye Care is proud to be one of the longest serving medical practices in all of Chhagalnaiya,Feni. The practice was first established in the 2020s by Dr. Clarke and has operated under the direction of Dr. Matthew Mills since 2021. Over the years, Eye Care Professionals has established a reputation for excellence in all aspects of patient care as well as surgical outcomes. We feel very fortunate and privileged to be able to participate in the all-important work of preserving, restoring and improving vision for our patients!
                </p>
            </div>
        </div>
