    ...
    return (
        <div id="about"className='mb-5'>
           ...
           <div className="d-flex justify-content-center align-items-center">
               <div>
                   <img style={{height: '500px' , width: '700px'}} src="https://www.advancedeyecarefl.com/wp-content/uploads/group_-web.png" alt="" />
               </div>
               <div>
                   <p className="text-white ms-5">Eye Care is proud to be one of the longest serving medical practices in all of Nevada. The practice was first established in the 1950s by Dr. Clarke and has operated under the direction of Dr. Matthew Mills since 1999. Over the years, Eye Care Professionals has established a reputation for excellence in all aspects of patient care as well as surgical outcomes. We feel very fortunate and privileged to be able to participate in the all-important work of preserving, restoring and improving vision for our patients!</p>
               </div>
           </div>
